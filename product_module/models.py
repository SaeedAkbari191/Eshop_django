...
class ProductGallery(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE, verbose_name='product_gallery')
    image = models.ImageField(upload_to='images/product-gallery', verbose_name='Gallery')
